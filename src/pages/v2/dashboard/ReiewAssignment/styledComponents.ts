...
import { ReactComponent as WordPadLogoSVG } from '../../../../assets/svg/wordpad-logo.svg'
...
`
export const HeadInfoDivider = styled.div`
  display: flex;
  /* justify-content: space-between; */
  width: 50%;
  @media (max-width: 650px) {
...
export const FlexAlign = styled.div`
  ...
  align-items: center;
`
export const WordPadLogo = styled(WordPadLogoSVG)`
  height: 22px;
  width: 22px;
  margin-left: 5px;
`
export const ReviewedStudent = styled.div<{ active?: boolean }>`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding: 15px 25px;
  ...
  cursor: pointer;
  ${({ active }) =>
    active ? 'box-shadow: 3px 3px 15px rgba(0, 0, 0, 0.1);' : ''}
  ${({ active }) => active && 'border-color: #2B3674;'}
...
export const StudentImage = styled.img`
  ...
  margin-right: 6px;
`
export const StatusReviewed = styled.div`
  height: 27px;
  width: 100px;
  font-size: 14px;
  font-weight: 600;
...
`
export const StatusOverdue = styled.div`
  height: 27px;
  width: 100px;
  font-size: 14px;
  font-weight: 600;
...
export const StatusPending = styled.div`
  ...
  border-radius: 13.5px;
`
export const StatusOntime = styled.div`
  height: 27px;
  width: 100px;
  font-size: 14px;
  font-weight: 600;
  ...
  border-radius: 13.5px;
`
export const StudentReviewPage = styled.div`
  max-height: 500px;
  width: 49%;
  border: 1px solid ${CoolGray20};
  background-color: ${White};
...
export const ReviewHeading = styled.div`
  ...
  color: ${Blue};
`
export const StudentProfileImage = styled.img`
  height: 50px;
  width: 50px;
  border-radius: 50%;
  margin-right: 10px;
...
export const InputFields = styled.div`
  padding: 0px 15px;
`
export const AssignmentFile = styled.div`
  font-size: 14px;
  font-weight: 500;
  color: ${Blue};
  margin-top: 15px;
...
export const WordLogoCircle = styled.div`
  ...
  cursor: pointer;
`
export const WordLogo = styled(WordPadLogoSVG)`
  height: 60px;
  width: 60px;
`
export const DocLogo = styled.img`
  height: 60px;
  width: 60px;
`
...
export const StudentName2 = styled.div`
  margin-bottom: 10px;
  font-family: DM Sans;
  font-size: 20px;
  font-weight: 500;
