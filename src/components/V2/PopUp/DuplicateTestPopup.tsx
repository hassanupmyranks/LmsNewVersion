...
const DuplicateTestPopUp = ({
  ...
  const submitHandler = () => {
    ...
    if (testName && instruction) {
      ...
      const payload = {
        test_id: testId,
        institute_test_name: testName,
        instruction_text: instruction
      }
      setIsLoading(true)
      createDuplicateTestAPI(payload)
        .then((res) => {
...
export default DuplicateTestPopUp
